...
class DependenciesUpdaterTest {
    private fun manifestWithDependencies(dependenciesJson: String): File {
        ...
        file.writeText(
            """
            {
              ...
              "popeDependencies": $dependenciesJson,
    ...
    fun `adding a dependency that didn't exist yet places the key right after version`() {
        ...
        assertTrue(
            text.indexOf("\"version\"") < text.indexOf("\"popeDependencies\"") &&
                text.indexOf("\"popeDependencies\"") < text.indexOf("\"buildPath\""),
            "Expected \"popeDependencies\" right after \"version\", got:\n$text",
        )
    }
}
